...
const buttons=['attack','skill','jump','guard'].map(act=>{const b=new Element();b.dataset.act=act;return b;});
...
for(let n=0;n<3;n++){let attacks=0,jumps=0;const engine={player:{},input:{},attack(){attacks++},jump(){jumps++},dash(){}};
