...
({e}=arena('blaster'));e.enemy.z=5;e.enemy.shield=1;e.enemy.guardWanted=true;e.attack(e.player,true);tick(e,1.5);assert.ok(e.events.shieldBreak,'strong skill breaks depleted shield');assert.ok(e.particles.some(p=>p.kind==='shieldBreak'));
