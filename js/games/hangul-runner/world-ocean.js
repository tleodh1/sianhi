(function(H){
 ...
 {number:1,name:'산호초 마을',words:['바','다','고','래'],story:'↑ 또는 점프를 누르면 위로, ↓는 아래로 수영해요.'},
 {number:2,name:'침몰한 배',words:['물','해','별','빛'],story:'물살을 거슬러 기포 속 글자를 찾아요.',current:true,cave:true},
 {number:3,name:'바닷속 유적',words:['바','다','고','래','상','어','문','어'],story:'바다 → 고래 → 상어 → 문어 순서로 모으면 문이 열려요.',ordered:true,current:true},
 {number:4,name:'바다의 왕',words:['다','래','어','어'],story:'바○ · 고○ · 상○ · 문○! 빈자리에 맞는 기포를 찾아요.',boss:{name:'물결왕 루모',style:'ocean',attacks:['ink','bubble','current'],questions:[['바○','다','나','라'],['고○','래','나','마'],['상○','어','가','다'],['문○','어','라','사']]}}
 ]);
