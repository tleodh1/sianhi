(function (R) {
  R.createView = function (canvas, arena = false) {
    ...
    const scene=new T.Scene();scene.background=new T.Color('#172858');
    ...
    const camera=new T.PerspectiveCamera(40,1,.1,100);camera.position.set(arena?10:4,arena?10:3.5,arena?14:6);camera.lookAt(0,arena?0:1.5,0);
