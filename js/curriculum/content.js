(function(global){
 ...
 function question(subject,stage){const info=curricula[subject][stage-1],fn=generators[subject]||reasoning;return B.generate(subject,stage,attempt=>({...info,...fn(stage,attempt),learningObjective:info.learningObjective,difficulty:Math.max(1,Math.min(10,info.difficulty+B.adaptive(subject))),conceptTags:info.conceptTags,questionPool:info.questionPool}));}
